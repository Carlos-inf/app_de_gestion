...
  const total = parseFloat(valor_total) || 0;
  const abono = parseFloat(abono_recibido) || 0;
  const valor_pendiente = total - abono;
...
    >
      <Stack gap="xs">
        {trabajo?.imagen_url || url_boceto ? ( // Uso de encadenamiento opcional para más seguridad
          <img
...
            {estado_pago}
          </Badge>
          {/* Ahora usamos el valor_pendiente calculado, que es un número seguro */}
          <Text 
            fw={700} 
            size="md" 
            c={valor_pendiente > 0 ? "red" : "green"}
          >
